...
const pugResponseA = `
	<div style="color: #a6ddff;">
		--------<br>
		<span style="font-size: 24px;">Name:</span> <span style="font-size: 18px; color: red;">Parapug</span><br>
		power level: <span style="color: red;">error</span><br>
		dims of orgin: <span style="color: red;">error</span><br>
	</div>
`;
